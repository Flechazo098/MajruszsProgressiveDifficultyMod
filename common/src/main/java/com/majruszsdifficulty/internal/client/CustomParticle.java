...
public abstract class CustomParticle extends TextureSheetParticle {
    ...
    public void render(VertexConsumer consumer, Camera camera, float partialTick) {
        ...
        consumer.addVertex(avector3f[0]).setUv(f7, f5).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setLight(light);
        consumer.addVertex(avector3f[1]).setUv(f7, f4).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setLight(light);
        consumer.addVertex(avector3f[2]).setUv(f6, f4).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setLight(light);
        consumer.addVertex(avector3f[3]).setUv(f6, f5).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setLight(light);
    }
