...
public class EffectHelper {
    ...
    public static Optional<Integer> getAmplifier(Supplier<? extends MobEffect> effect, LivingEntity entity) {
        return Optional.ofNullable(entity.getEffect(holder(effect))).map(MobEffectInstance::getAmplifier);
    }

    public static Optional<Integer> getDuration(Supplier<? extends MobEffect> effect, LivingEntity entity) {
        return Optional.ofNullable(entity.getEffect(holder(effect))).map(MobEffectInstance::getDuration);
    }

    private static Holder<MobEffect> holder(Supplier<? extends MobEffect> effect) {
    ...
    public static class Applier {
        ...
        public void apply(LivingEntity entity) {
            ...
            MobEffectInstance previous = entity.getEffect(holder(this.effect));
            if (previous != null) {
            ...
            entity.addEffect(new MobEffectInstance(holder(this.effect), duration, amplifier));
        }
