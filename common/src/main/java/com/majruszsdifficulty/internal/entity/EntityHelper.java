...
import com.majruszsdifficulty.internal.platform.EntityData;
import com.majruszsdifficulty.internal.platform.Side;
import com.majruszsdifficulty.internal.time.TimeHelper;
import com.majruszsdifficulty.mixin.IMixinMobAccessor;
...
public class EntityHelper {
    ...
    public static GoalSelector getGoalSelector(Mob mob) {
        return ((IMixinMobAccessor) mob).majruszsdifficulty$getGoalSelector();
    }

    public static GoalSelector getTargetSelector(Mob mob) {
        return ((IMixinMobAccessor) mob).majruszsdifficulty$getTargetSelector();
    }
    ...
    public static CompoundTag getOrCreateExtraTag(Entity entity) {
        return EntityData.getOrCreate(entity);
    }
