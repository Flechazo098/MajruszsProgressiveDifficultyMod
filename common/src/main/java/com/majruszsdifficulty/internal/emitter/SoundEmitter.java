package com.majruszsdifficulty.internal.emitter;
...
public class SoundEmitter {
    ...
    public void send(ServerPlayer player) {
        Vec3 position = this.position.get();
        player.connection.send(new ClientboundSoundPacket(BuiltInRegistries.SOUND_EVENT.wrapAsHolder(this.event), this.source, position.x, position.y, position.z, this.volume.get(), this.pitch.get(), Random.nextInt()));
    }
