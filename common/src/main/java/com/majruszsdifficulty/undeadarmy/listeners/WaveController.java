...
public class WaveController {
    ...
    private static void tickStarted(UndeadArmy undeadArmy) {
        if (WaveController.isPhaseOver(undeadArmy)) {
            undeadArmy.setState(UndeadArmy.Phase.State.WAVE_PREPARING, (float) UndeadArmyConfig.get().preparingDuration());
        }
    }
    ...
    private static void tickWavePreparing(UndeadArmy undeadArmy) {
        if (WaveController.isPhaseOver(undeadArmy)) {
            ...
            undeadArmy.setState(UndeadArmy.Phase.State.WAVE_ONGOING, (float) UndeadArmyConfig.get().waveDuration());
        }
    }
