...
public class CreeperlingRenderer extends MobRenderer<Creeperling, CreeperlingModel<Creeperling>> {
    public static final ModelLayerLocation LAYER = MajruszsDifficulty.layer("creeperling");
    public static final ResourceLocation TEXTURE = MajruszsDifficulty.id("textures/entity/creeperling.png");
