...
public class GiantRenderer extends MobRenderer<Giant, GiantModel<Giant>> {
    public static final ModelLayerLocation LAYER = MajruszsDifficulty.layer("giant");
    public static final ResourceLocation TEXTURE = MajruszsDifficulty.id("textures/entity/giant.png");
